...
export type VideoType = 'auto' | 'hls' | 'mpegts' | 'mpeg2toh264' | 'tlv' | 'flv' | 'dash' | 'webtorrent' | 'normal';
...
export type PlayerEvents = 'screenshot' | 'thumbnails_show' | 'thumbnails_hide' | 'danmaku_show' | 'danmaku_hide' | 'danmaku_clear' | 'danmaku_load_start' | 'danmaku_load_end' | 'danmaku_send' | 'danmaku_opacity' | 'contextmenu_show' | 'contextmenu_hide' | 'notice_show' | 'notice_hide' | 'quality_start' | 'quality_end' | 'destroy' | 'resize' | 'fullscreen' | 'fullscreen_cancel' | 'webfullscreen' | 'webfullscreen_cancel' | 'subtitle_show' | 'subtitle_hide' | 'subtitle_change' | 'tlv_ready' | 'tlv_error' | 'tlv_playback_damage' | 'tlv_playback_mode' | 'tlv_tracks' | 'tlv_track_change' | 'tlv_layer_change' | 'tlv_mpt_snapshot' | 'tlv_video_properties' | 'tlv_output_state' | 'tlv_caption_data' | 'tlv_broadcast_clock' | 'tlv_layout_configuration' | 'tlv_event_info' | 'tlv_stream_event' | 'tlv_viewer_participation' | 'tlv_application_state' | 'tlv_application_resource' | 'tlv_application_resources_reset';
